    ...
    public class WordOperate
    {
        ...
        public static string CreateWordFile()
        {
            ...
            try
            {
                ...
                WordApp.Selection.ParagraphFormat.Alignment = Word.WdParagraphAlignment.wdAlignParagraphLeft;//设置左对齐   
                ...
                //文档中创建表格
                Word.Table newTable = WordDoc.Tables.Add( WordApp.Selection.Range, 12, 3, ref oMissing, ref oMissing );
                //设置表格样式
        ...
        public static void WordToHtml( string strFileName, string strSaveFileName )
        {
            ...
            docType.InvokeMember( "SaveAs", System.Reflection.BindingFlags.InvokeMethod, null, WordDoc, new object[] { saveFileName, Word.WdSaveFormat.wdFormatHTML } );
        ...
        public static void AddRow()
        {
            ...
            Word.Table newTable = WordDoc.Tables[1];
        ...
        public static void CombinationCell()
        {
            ...
            Word.Cell cell = newTable.Cell( 2, 1 );//2行1列合并2行2列为一起
        ...
        public static void WordSet()
        {
            ...
            WordApp.ActiveDocument.PageSetup.Orientation = Word.WdOrientation.wdOrientPortrait;//页面方向
            ...
            WordApp.ActiveDocument.PageSetup.FirstPageTray = Word.WdPaperTray.wdPrinterDefaultBin;//纸张来源
            WordApp.ActiveDocument.PageSetup.OtherPagesTray = Word.WdPaperTray.wdPrinterDefaultBin;//纸张来源
            WordApp.ActiveDocument.PageSetup.SectionStart = Word.WdSectionStart.wdSectionNewPage;//节的起始位置：新建页
            ...
            WordApp.ActiveDocument.PageSetup.VerticalAlignment = Word.WdVerticalAlignment.wdAlignVerticalTop;//页面垂直对齐方式
            ...
            WordApp.ActiveDocument.PageSetup.GutterPos = Word.WdGutterStyle.wdGutterPosLeft;//装订线位于左侧
            WordApp.ActiveDocument.PageSetup.LinesPage = 40;//默认页行数量
            WordApp.ActiveDocument.PageSetup.LayoutMode = Word.WdLayoutMode.wdLayoutModeLineGrid;//版式模式为“只指定行网格”
            #endregion
            ...
            WordApp.Selection.ParagraphFormat.Alignment = Word.WdParagraphAlignment.wdAlignParagraphJustify;//段落2端对齐
            ...
            WordApp.Selection.ParagraphFormat.OutlineLevel = Word.WdOutlineLevel.wdOutlineLevelBodyText;
            ...
            WordApp.Selection.ParagraphFormat.BaseLineAlignment = Word.WdBaselineAlignment.wdBaselineAlignAuto;
            #endregion
            ...
            WordApp.Selection.Font.Color = Word.WdColor.wdColorAutomatic;
            ...
            WordApp.Selection.Font.Animation = Word.WdAnimation.wdAnimationNone;//文字效果
            WordApp.Selection.Font.DisableCharacterSpaceGrid = false;
            WordApp.Selection.Font.EmphasisMark = Word.WdEmphasisMark.wdEmphasisMarkNone;

            #endregion

            #region 获取光标位置
            ////get_Information
            WordApp.Selection.get_Information(Word.WdInformation.wdActiveEndPageNumber);
            //关于行号-页号-列号-位置
            //information 属性 
            ...
            //unit对象定义
            object unith = Word.WdUnits.wdRow;//表格行方式
            object extend = Word.WdMovementType.wdExtend;/**//**////extend对光标移动区域进行扩展选择
            object unitu = Word.WdUnits.wdLine;//文档行方式,可以看成表格一行.不过和wdRow有区别
            object unitp = Word.WdUnits.wdParagraph;//段落方式,对于表格可以选择到表格行后的换车符,对于跨行合并的行选择,我能找到的最简单方式
